 ...
 * Use the [UsersLkFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class UsersLkFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UsersLkFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                UsersLkFragment().apply {
